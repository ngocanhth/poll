...
class InstallSchema implements \Magento\Framework\Setup\InstallSchemaInterface{
	...
	public function install(SchemaSetupInterface $setup, ModuleContextInterface $context){
      ...
      //  $installer->getConnection()->dropTable($installer->getTable('poll'));
       // $installer->getConnection()->dropTable($installer->getTable('poll_answer'));
        // $installer->getConnection()->dropTable($installer->getTable('emipro_auction_bid'));
        // $installer->getConnection()->dropTable($installer->getTable('emipro_auction_autobid'));
